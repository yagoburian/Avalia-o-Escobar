...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>/public/assets/vendors/iconfonts/ionicons/css/ionicons.css">
    <link rel="stylesheet" href="<?php echo base_url();?>/public/assets/vendors/iconfonts/typicons/src/font/typicons.css">
  ...
  <body>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="<?php echo base_url();?>/public/assets/images/faces/face10.jpg" alt="image" class="img-sm profile-pic"> </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="<?php echo base_url();?>/public/assets/images/faces/face12.jpg" alt="image" class="img-sm profile-pic"> </div>
                  <div class="preview-item-content flex-grow py-2">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="<?php echo base_url();?>/public/assets/images/faces/face1.jpg" alt="image" class="img-sm profile-pic"> </div>
                  <div class="preview-item-content flex-grow py-2">
          ...
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">Yago</p>
                  <p class="designation">Bala</p>
                </div>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/contatos/novo">
                ...
                <span class="menu-title">Novo Contato</span>
              </a>
    ...
    <script src="<?php echo base_url();?>/public/assets/js/demo_1/dashboard.js"></script>
